            ...
            <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div className="mt-2 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        <div className="p-4 mr-2 bg-gray-200 sm:rounded-lg">
                            ...
                            <div className="flex items-center mt-8 text-gray-600">
                                ...
                                <div className="ml-4 text-md tracking-wide font-semibold w-40">
                                    JECRC University, Vidhani, 303905
                                </div>
                            </div>
                            ...
                            <div className="flex items-center mt-2 text-gray-600">
                                ...
                                <p className="ml-4 text-md tracking-wide font-semibold w-40 mt-4">
                                    khushisharma031704@gmail.com
                                    princejain1608@gmail.com
                                    psing7879@gmail.com
                                    Tanishqv90@gmail.com
                                </p>
                            </div>
                        </div>
